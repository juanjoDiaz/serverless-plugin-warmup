...
class WarmUP {
  ...
  afterDeployFunctions () {
    ...
    if (this.warmup.cleanFolder) {
      return fs.removeAsync(this.pathArchive).then(() => {
  ...
  createArtifact () {
    ...
    return this.archiveDirectory(src, this.pathArchive, 'zip', { archiverOptions: { zlib: { level: 9 } }, directoryDestPath: this.folderName })
  }
